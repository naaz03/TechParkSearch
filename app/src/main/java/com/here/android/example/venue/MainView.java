...
public class MainView {
    ...
    private EditText m_techPark;
    private Button m_showMap;
    ...
    private void initUIElements() {
        m_techPark=(EditText)m_activity.findViewById(R.id.et_tech_park_name);
        m_showMap=(Button)m_activity.findViewById(R.id.showMap);
        ...
        if(m_techPark.getText().toString().equals("")){
            m_showMap.setEnabled(false);
        }
        ...
        geocodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(m_techPark.getText().toString().equals(""))
                {
                    Toast.makeText(m_activity,"Please enter search text",Toast.LENGTH_SHORT).show();
                    m_showMap.setEnabled(false);
                }
                else
                {
                    triggerGeocodeRequest();
                    m_showMap.setEnabled(true);
                }
            }
        });
        ...
        m_showMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(m_activity,Venue3dActivity.class);
                String coords=m_resultTextView.getText().toString();
    ...
    private void triggerGeocodeRequest() {
         ...
         */
        //String query = "7, Whitefield Main Road, Opp. Varthur Lake, Varthur Kodi, Banglore, Karnataka 560066";
        String query=m_techPark.getText().toString();
        GeocodeRequest geocodeRequest = new GeocodeRequest(query);
        GeoCoordinate coordinate = new GeoCoordinate(12.972442, 77.580643);
